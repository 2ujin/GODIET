...
<form method="post" action="catjoin.jsp">
<table>
	<tr>
	...
	<tr>
		<td width="200" height="50">고양이 이름  *</td>
		<td><input type="text" id="text1" name="catname" required></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" id="text1" name="leg" required></td>
	</tr>
</table><hr><br>
